...
$LogFile = Join-Path (Split-Path $PSScriptRoot -Parent) "LOG\Fix_Activity.log"
...
# AGRESSZIV WHITELIST - Ezeket TILOS letiltani
$WhiteList = @("*Keyboard*", "*Mouse*", "*HID*", "*Network*", "*Wireless*", "*Wi-Fi*", "*Ethernet*", "*Touchpad*")

# CSAK A VGA ES AUDIO TILTASA
...
# MARADEK HIBASOK (Whitelist ellenorzessel)
